...
public interface OpenFLCertificate extends OpenFLAbstractCondition {
  @NotNull
  ...
  @NotNull
  GenericAttributeValue<String> getAliasPassword();
  @NotNull
  GenericAttributeValue<String> getIdentity();
}
